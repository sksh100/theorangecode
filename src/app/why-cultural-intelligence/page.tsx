...
import { TrendingUp, Users, Globe, Target, CheckCircle, ArrowRight, BarChart3, Lightbulb, Shield, Zap, Heart, Sparkles } from 'lucide-react'
      ...
      >
        ...
        <section className="relative overflow-hidden">
          <div className="relative h-[50vh] sm:h-[60vh] md:h-[70vh] w-full">
            <Image
              src="/why-cultural-intelligence-matters-image.png"
              alt="Why Cultural Intelligence Matters"
              fill
            ...
            >
              ...
              >
                <div className="relative z-10 text-center space-y-6">
                  ...
                  >
                    <Sparkles className="w-16 h-16 text-orange mx-auto mb-6" />
                  </motion.div>
                  <h2 className="text-3xl md:text-4xl font-bold">
                    <span className="bg-gradient-to-r from-orange via-azure-blue to-orange bg-clip-text text-transparent">
