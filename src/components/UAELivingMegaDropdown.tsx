...
import { Home, Plane, ArrowRight, X } from 'lucide-react'
import Link from 'next/link'
import { useEffect } from 'react'
import { trackDropdownItemClick } from '@/lib/analytics'

interface UAELivingCard {
  id: string
  title: string
  description: string
  icon: any
...
interface UAELivingMegaDropdownProps {
  isOpen: boolean
  onClose: () => void
}

export function UAELivingMegaDropdown({ isOpen, onClose }: UAELivingMegaDropdownProps) {
  useEffect(() => {
    if (isOpen) {
                  ...
                  {uaeLivingSections.map((section, index) => (
                    ...
                    >
                      <Link
                        href={section.href}
                        onClick={() => {
                          trackDropdownItemClick('UAE Living', section.title, section.href)
                          onClose()
                        }}
